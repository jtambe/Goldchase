...
char PlayersPlayingNow()
{
  char playersPlayingNow = 0;
...
void serverSighandler(int signal)
{
  ...
  {
    char playersPlayingNow = PlayersPlayingNow();
    char socketPlayer = G_SOCKPLR | playersPlayingNow;
...
void CreateServer()
{
 ...
 //  	read(shm_fd1, &colp, sizeof(int));
	...
	// cerr << "testing";
	// cerr << servmap_Pointer->rows <<endl;
	// cerr << servmap_Pointer->cols <<endl;

	// for(int i =0; i < servmap_Pointer->rows*servmap_Pointer->cols; i++)
	// {
	// 	if( servmap_Pointer->map[i] == G_WALL)
	// 	{
	// 		cerr << "*";
	// 	}
	// 	if( servmap_Pointer->map[i] == G_PLR0)
	// 	{
	// 		cerr << "1";
	// 	}
	// 	else
